...
namespace gRPCGraphQLWebSockets.gRPC
{
    public class gRPCMessagesService : Proto.gRPCMessagesService.gRPCMessagesServiceBase
    {
        ...
        public override Task<gRPCGetMessagesResponse> GetMessages(gRPCGetMessagesRequest messageRequest, ServerCallContext context)
        {
        ...
        public override Task<gRPCCreateMessageResponse> CreateMessage(gRPCCreateMessageRequest messageRequest, ServerCallContext context)
        {
